...
public class LiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference(user.getUid()+"/"+"timeline");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference(user.getUid()+"/"+"timeline");
        setGetPhotoView();
    ...
    private void detectObject(){
        ...
        try{
            ...
            InputStream bitmap1=getAssets().open("lb.JPG");
            Bitmap bit=BitmapFactory.decodeStream(bitmap1);
            bit.compress(Bitmap.CompressFormat.JPEG, 100, baos1);
            byte[] data1 = baos1.toByteArray();
            final String result1=Base64.encodeToString(data1, Base64.DEFAULT);
                        ...
                        mUploadTask = fileReference.putFile(uri)
                                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        Toast.makeText(LiveActivity.this, "Upload Successful", Toast.LENGTH_LONG).show();
                                        String text1 = "";
                                        String yValue;
